...
const AboutPage = () => {
  return (
    <div className='flex flex-col items-center min-h-screen mt-8'>
      <h1 className='text-green-700 font-bold text-3xl'>ABOUT</h1>
      <div className='mt-2 border border-yellow-500 w-full '></div>
      <div className='flex flex-col w-full mt-8 mx-4 gap-16 md:flex-row'>
        <Image className='mx-4 border border-l-8 border-t-0 border-b-4 border-r-0 border-green-500' src={"/assets/about.jpg"} height={500} width={800} alt=''/>
